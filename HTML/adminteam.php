...
<html lang="en">
  ...
  <h1 class="orca">Orca Service Admin</h1>
    ...
    <tr>
            ...
            <div class="clearfix">
      <button type="submit" name="abt" class="updtbtn">Edit</button>
</div>
    </tr>      
        </form>
        ...
        <form action="" method ="POST"  class="container-admin">
            <tr>
                ...
                <td>Address</td>
                <td>:</td>
                <td><input class ="edit-home" type="text" name="Address" placeholder = "paragraph1" value=""></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>:</td>
                <td><input class ="edit-home" type="text" name="Email" placeholder = "paragraph1" value=""></td>
            </tr>
            <tr>
                <td>Whatsapp</td>
                <td>:</td>
                <td><input class ="edit-home" type="text" name="Whatsapp" placeholder = "paragraph1" value=""></td>
            </tr>
            <tr>
                <td>Telepon</td>
                <td>:</td>
                <td><input class ="edit-home" type="text" name="Telepon" placeholder = "paragraph1" value=""></td>
            </tr>
            <tr>
                <td>Map</td>
                <td>:</td>
  ...
  <div class="container">
    ...
    <input type="text" placeholder="NIM" name="nim" required value="<?php echo$nim?>">

    <label for="psw"><b>Nama</b></label>
    <input type="text" placeholder="NAMA" name="nama" required value="<?php echo$nama?>">

    <label for="psw-repeat"><b>Kelas</b></label>
    <input type="text" placeholder="Kelas" name="kelas" required value="<?php echo$kelas?>">

    <div class="clearfix">
      <button type="submit" name="simpan" class="editbtn">Submit</button>
    </div>
  </div>
</form>
  ...
  <div class="container">
    ...
    <label for="email"><b>NIM</b></label>
    <input type="text" placeholder="NIM" name="nim" required value="<?php echo$nim2?>">

    <label for="psw"><b>Nama</b></label>
    <input type="text" placeholder="NAMA" name="nama" required value="<?php echo$nama2?>">

    <label for="psw-repeat"><b>Kelas</b></label>
    <input type="text" placeholder="Kelas" name="kelas" required value="<?php echo$kelas2?>">
...
<form action=""  method="POST">
  <div class="container">
    ...
    <label for="email"><b>NIM</b></label>
    <input type="text" placeholder="NIM" name="nim" required value="<?php echo$nim3?>">

    <label for="psw"><b>Nama</b></label>
    <input type="text" placeholder="NAMA" name="nama" required value="<?php echo$nama3?>">

    <label for="psw-repeat"><b>Kelas</b></label>
    <input type="text" placeholder="Kelas" name="kelas" required value="<?php echo$kelas3?>">
...
<form action=""  method="POST">
  <div class="container">
    ...
    <label for="email"><b>NIM</b></label>
    <input type="text" placeholder="NIM" name="nim" required value="<?php echo$nim4?>">

    <label for="psw"><b>Nama</b></label>
    <input type="text" placeholder="NAMA" name="nama" required value="<?php echo$nama4?>">

    <label for="psw-repeat"><b>Kelas</b></label>
    <input type="text" placeholder="Kelas" name="kelas" required value="<?php echo$kelas4?>">
  ...
  <div class="container">
    ...
    <label for="email"><b>NIM</b></label>
    <input type="text" placeholder="NIM" name="nim" required value="<?php echo$nim5?>">

    <label for="psw"><b>Nama</b></label>
    <input type="text" placeholder="NAMA" name="nama" required value="<?php echo$nama5?>">

    <label for="psw-repeat"><b>Kelas</b></label>
    <input type="text" placeholder="Kelas" name="kelas" required value="<?php echo$kelas5?>">
